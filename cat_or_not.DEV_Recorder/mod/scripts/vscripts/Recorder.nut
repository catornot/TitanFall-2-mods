...
const string HEADER = "// ======= generated script using DEV_recorder by catornot =======\n\n" +
                    ...
                    "const table WALLRUN_MAP = { left = \"pt_wallrun_hang_left\", right =
\"pt_wallrun_hang_right\", back = \"pt_wallrun_hang_up\", front = \"pt_wallrun_hang_front\"
}\n\n" +
                    "struct Recording {\n" +
                    "	entity mover\n" +
                    "	entity pilot\n" +
...
const string FOOTER = "}\n\n" +
                    ...
                    "	recording.pilot.Anim_SetInitialTime( recording.pilot.GetSequenceDuration( \"ACT_MP_CROUCHWALK_FORWARD\" ) * ( recording.state ? 0.0 :
0.05 ) )\n" +
                    "}\n\n" +
