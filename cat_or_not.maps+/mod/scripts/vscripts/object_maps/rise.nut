...
void function placeRiseObjects()
{
	...
	file.terminals.append(
		CreateExpensiveScriptMoverModel( $"models/communication/terminal_com_station_tall.mdl", < 4297, 2, 1623 >, < 0, 180, 0 >, SOLID_VPHYSICS, 10000 )
	)
	file.terminals.append(
		CreateExpensiveScriptMoverModel( $"models/communication/terminal_com_station_tall.mdl", < -6151, -2590, 1556 >, < 0, 180, 0 >, SOLID_VPHYSICS, 10000 )
	)
	file.terminals.append(
		CreateExpensiveScriptMoverModel( $"models/communication/terminal_com_station_tall.mdl", < -3223, 1829, 320 >, < 0, 180, 0 >, SOLID_VPHYSICS, 10000 )
	)
		...
		function() : ( player, time )
		{
			...
			else if ( finalTime > 40.0 )
			{
				Chat_ServerPrivateMessage(
					player,
					"\x1b[32m[Sarah]\x1b[0m I will give you a good reward, but if you can do it even faster there will probably be a better reward.",
					false,
					false
				)
				player.TakeOffhandWeapon( OFFHAND_SPECIAL )
