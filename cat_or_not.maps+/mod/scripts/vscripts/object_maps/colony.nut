...
void function placeColonyObjects()
{
    ...
    {
        entity button = CreateSimpleButton( <405.671, 115.202, 1039.96> + <0,10,-4>, <0, 0, 30>, "to spawn a dropship", callback_dropShipButtonTriggered )
        CreateSimpleButton( <405.671, 115.202, 1039.96> + < 50,10,-4 >, <0, 0, 30>, "to show the Nessy", callback_NessyButtonTriggered )
        CreateNessyMessager( button.GetOrigin() + <0,30,0>, <0,180,0>, "The tower is on a cooldown. Try !dropship in the chat <3." )
    }
    CreateSimpleButton( <349,1598,132>, <0, 90, 30>, "to trade in your monarch", callback_tradeButtonTriggered, 10 )
...
void function callback_NessyButtonTriggered( entity button, entity player )
{
    ...
    Chat_ServerPrivateMessage( player, "Nessy is somewhere over there ( you might need a dropship to get there )", false )
}
