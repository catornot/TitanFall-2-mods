...
global function ResupplyCoresThink
...
void function placeBoomTownObjects()
{
	...
	CreateSimpleButton( < 2531, -5115, 2436 >, < 0, 90, 0 >, "to launch yourself", callback_AntiGravButtonTriggered, 5.0 )
	...
	file.terminals.append(
		CreateExpensiveScriptMoverModel( $"models/communication/terminal_com_station_tall.mdl", < 5985, -4390, 2257 >, < 0, 180, 0 >, SOLID_VPHYSICS, 10000 )
	)
	file.terminals.append(
		CreateExpensiveScriptMoverModel( $"models/communication/terminal_com_station_tall.mdl", < 11322, -1662, 1954 >, < 0, 180, 0 >, SOLID_VPHYSICS, 10000 )
	)
	file.terminals.append(
		CreateExpensiveScriptMoverModel( $"models/communication/terminal_com_station_tall.mdl", < -2366, -1726, 1950 >, < 0, 180, 0 >, SOLID_VPHYSICS, 10000 )
	)
...
void function DropTitans()
{
	...
	for ( ; ; )
	{
		...
		if ( SelectedPlace != < 0, 0, 0 > && GetEntArrayByScriptName( "ions" ).len() < 10 )
		{
			...
			thread ResupplyCoresThink( titan )
		}
...
void function ResupplyCoresThink( entity titan )
{
...
void function FlyVoper()
{
	...
	for ( ; ; )
	{
		...
		link.NonPhysicsRotateTo( enemy.GetAngles() + < 0, 180, 0 >, 1.0e-8, 0, 0 )
