...
void function placeDrydockObjects()
{
	...
	CreateSimpleButton( < 2706, 339, 294 >, < 0, 0, 0 >, "to close/open doors below", MoveDoors, 20 )

	file.door1 =
		CreateExpensiveScriptMoverModel( $"models/levels_terrain/mp_drydock/dd_warehouse14_panel_01.mdl", < 2518, 134, 66 >, < 0, 90, 0 >, SOLID_VPHYSICS, 10000 )
	file.door2 =
		CreateExpensiveScriptMoverModel( $"models/levels_terrain/mp_drydock/dd_warehouse14_panel_01.mdl", < 2518, 534, 66 >, < 0, 90, 0 >, SOLID_VPHYSICS, 10000 )

	entity door1 = CreateExpensiveScriptMoverModel(
	...
	entity door2 = CreateExpensiveScriptMoverModel(
		$"models/levels_terrain/mp_drydock/dd_warehouse14_panel_01.mdl",
		< 2518, 534, 66 >,
		< 0, 90, 0 >,
		SOLID_VPHYSICS,
...
void function OnPanelHacked2( entity panel, entity player )
{
	// expect entity( panel )
	// expect entity( player )
...
void function SarahEscortThink( vector origin, entity player )
{
	...
	OnThreadEnd(
		function() : ( sarah, player, ship, ref )
		{
			...
			if ( file.sarahSpawned && ( !IsAlive( sarah ) || !IsAlive( player ) ) && IsValid( player ) )
				Chat_ServerPrivateMessage( player, "You failed to the escort mission", false )
	...
	Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m follow me", false, false )
	...
	// Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m Phaseshifting", false, false )
	...
	// Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m Come closer", false, false )
	...
	// Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m Go go go!", false, false )
	...
	if ( !slow )
		Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m We got to the dropship", false, false )
	...
	if ( !slow )
	{
		Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m Here, You can have this gift.", false, false )
		StimPlayer( player, 1000000 )
	}

	wait 2

	Chat_ServerPrivateMessage( player, "\x1b[32m[Sarah]\x1b[0m Blast off", false, false )
