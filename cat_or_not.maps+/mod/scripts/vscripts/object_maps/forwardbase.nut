...
{
    CreateSimpleButton( < -425, 220, 1000 >, <90, 0, 0>, "to control the grav lift", callback_ButtonTriggered, 5.0 )
    ...
    CreateSimpleButton( < 1185, 905, 1140 >, <0, 0, 30>, "to open the portal", callback_ValidatePortalRequest, 120.0 )

    CreateSimpleButton( < 894, 771, 1000 >, <0,0,0>, "to fight voper", callback_ValidateVoperRequest, 1.0 )
}
