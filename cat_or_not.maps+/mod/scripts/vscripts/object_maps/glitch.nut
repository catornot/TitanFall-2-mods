...
global function threaded_remove_outofbounds_timer
...
void function placeGlitchObjects()
{
	...
	CreateSmallElevator( < 326, 142, -888 >, < 326, 142, 1025 >, 6 )
...
void function GambleDeath( entity player )
{
	...
	for ( int x = 0; x < 5; x++ )
		weapon.FireWeaponGrenade(
			spectre.GetOrigin() + < 0, 0, 50 >,
			< 0, 180, 0 >,
			< 0, 0, 0 >,
			1,
			damageTypes.projectileImpact,
