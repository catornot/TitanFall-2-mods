...
void function NPC_Init()
{
	...
	{
		file.current = [ Vector( 750, -12, 0 ), Vector( -750, 12, 0 ), Vector( 0, 0, 0 ) ]
		thread spawn_obj()
	}
	else
	{
...
void function tutorial( entity player )
{
	...
	SendHudMessage(
		player,
		"Hello, This is BatteryYoink, In this gamemode you kill NPCs and collect there batteries.\nTo score a point You need to go to a shop and jump near it.\nYou can also get better wepons if you crouch near a shop",
		-1,
		0.2,
		255,
		255,
...
void function AddPlayerToAmped( entity player )
{
	...
	if ( !in_list )
		file.amped_players.append( player )
}
