//
// This is the config file for the Player Info Tracker Mod, if you are working on a
// mod yourself feel free to use anything inside this script if you find it helpful
