...
const WeaponBarrelInfo = {
	[ModelMT] = [
		{ muzzleFlashTag = "MUZZLE_LEFT_UPPER", shellEjectTag = "SHELL_LEFT_UPPER" },
		{ muzzleFlashTag = "MUZZLE_LEFT_LOWER", shellEjectTag = "SHELL_LEFT_LOWER" },
		{ muzzleFlashTag = "MUZZLE_RIGHT_UPPER", shellEjectTag = "SHELL_RIGHT_UPPER" },
		{ muzzleFlashTag = "MUZZLE_RIGHT_LOWER", shellEjectTag = "SHELL_RIGHT_LOWER" }
	]
}
