...
void function CodeCallback_MapInit()
{
	...
	FastballAddPanelSpawnsForLevel(
		"mp_mirror_city",
		[ < 1983, 2064, 3072 >, < 0, 90, 0 >, < -2064, -1282, -2559 >, < 0, 180, 0 >, < 1919, -2080, 4096 >, < 0, -90, 0 > ]
	)
...
bool function PROTO_Swap( entity player, array<string> args )
{
	...
	TraceResults results = TraceLine(
		player.GetOrigin() + Vector( 0, 0, 32 ),
		player.GetOrigin() + Vector( 0, 0, -200 ),
		[ player ],
		TRACE_MASK_NPCSOLID_BRUSHONLY | TRACE_MASK_WATER,
